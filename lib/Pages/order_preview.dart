...
import 'package:driver/Providers/push_notification.dart';
...
class _OrdersPreviewState extends State<OrdersPreview> {
  ...
  void _handleSendNotification(
    ...
    PushNotificationFunction.sendPushNotification(heading, content, playerId);
  }
  ...
  getDeliveryLocationLatAndLong() async {
            // ignore: avoid_print
         print('working $deliveryAddressLat');
    if (deliveryAddressLat == 0 && deliveryAddressLong == 0) {
       List<Location> locations = await locationFromAddress(widget.orderModel.deliveryAddress);
