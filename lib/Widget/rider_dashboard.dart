...
import 'package:driver/Pages/cashout.dart';
import 'package:driver/Widget/paystack.dart';
import 'package:driver/Widget/stripe.dart';
import 'package:easy_localization/easy_localization.dart';
import 'flutterwave/flutterwave_web_widget.dart';

class RiderDashboard extends StatefulWidget {
  final String id;
  const RiderDashboard({super.key, required this.id});
      ...
      children: [
        ...
        flutterwave == false
            ...
            : InkWell(
                onTap: () {
                  Navigator.of(context).push(MaterialPageRoute(
                      builder: (context) => const FlutterwaveWebWidget()));
                },
                child: SizedBox(
                  height: 250,
                  width: 180,
